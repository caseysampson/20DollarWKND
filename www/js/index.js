...
var match = function() {
  ...
  var showEndGame= function() {
    if ( ( ((playerOne.games == 1) && (playerTwo.games == 0)) || ((playerOne.games == 0) && (playerTwo.games == 1)) ) || ( ((playerOne.games > 6) && (playerOne.games - playerTwo.games > 2)) || ((playerTwo.games > 6) && (playerTwo.games - playerOne.games > 2)) ) ){      
